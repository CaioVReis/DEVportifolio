...
const Cards = ({ icon, text, disc }) => {
    return (
        <div className="md:w-[400px] md:h-[300px]  flex flex-col justify-center md:flex md:flex-col rounded-md bg-[#1E1D1D] border border-[#00f7ef] hover:shadow-md hover:shadow-[#00f7ef] hover:scale-105 ">
